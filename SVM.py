...
def run_svm(data, distancia, kernel='linear'):
    ...
    # Salvar a imagem
    # plt.savefig(f'analise_SVM_{kernel}_{distancia}.png')

    # Exibir o gráfico
    plt.show()

# Exemplo de uso:
run_svm(pd.read_csv('database1_5km.csv'), '1500m', kernel='linear')
run_svm(pd.read_csv('database2_5km.csv'), '2500m', kernel='linear')
run_svm(pd.read_csv('database2km.csv'), '2000m', kernel='linear')
run_svm(pd.read_csv('database1km.csv'), '1000m', kernel='linear')
run_svm(pd.read_csv('database500m.csv'), '500m', kernel='linear')
run_svm(pd.read_csv('database1_5km.csv'), '1500m', kernel='rbf')
run_svm(pd.read_csv('database2_5km.csv'), '2500m', kernel='rbf')
run_svm(pd.read_csv('database2km.csv'), '2000m', kernel='rbf')
run_svm(pd.read_csv('database1km.csv'), '1000m', kernel='rbf')
run_svm(pd.read_csv('database500m.csv'), '500m', kernel='rbf')